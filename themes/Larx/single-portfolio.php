...
if( $head_is_overlay !='' && $head_is_overlay == 1){
    $overlay_class = 'class="parallax-overlay"';
}
...
<!-- Header Background Parallax Image -->
        <div <?php echo $th_project_alter_bg; ?> id="project_single" <?php echo $overlay_class ?>>
            <div class="container">
                        ...
                        if( !empty($content) ): ?>
                            ...
                            <div class="col-md-9 about-caption">
                               <!-- <div class="general-title">
                                    <!--<h2><?php //echo esc_attr_e('Project images', 'Spacemakeover') ?></h2>
