...
function th_portfolio_grid($attrs,$content=false){
    ...
    $html='';
    ?> 
	<?php /*?>$html.='<div id="filters-container" class="cbp-l-filters-alignRight">';
    $html.="<div data-filter=\"*\" class=\"cbp-filter-item-active cbp-filter-item\">".__('All','larx')."
    ...
    $html.='</div><!--End #filters-container-->';<?php */?>
    ...
    while(have_posts())
    {
        ...
        $html.="<li class=\"cbp-item {$term_string} {$item_class}\">
                    ...
                    <a class=\"cbp-caption {$th_is_lightbox} \" data-title=\"{$title}\" href=\"{$full}\">
                        ...
                        <div class=\"cbp-caption-activeWrap\">
                            <div class=\"cbp-l-caption-alignCenter\">
                                <div class=\"cbp-l-caption-body\">
									...
									<div class=\"cbp-l-caption-desc\">Click for more pics</div>
                                </div>
                            </div>
                        </div>
                    </a>
